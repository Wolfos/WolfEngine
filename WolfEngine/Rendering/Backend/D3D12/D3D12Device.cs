...
public sealed unsafe class D3D12Device : IGfxDevice, ITexturePoolDevice, IGpuSubmissionTimeline, IGpuProfilerDevice, IDisposable
{
	...
	private ComPtr<ID3D12CommandSignature> EnsureGraphicsExecuteIndirectSignature()
	{
		...
		var argumentDescs = stackalloc IndirectArgumentDesc[16];
		...
		argumentDescs[5].Anonymous.ConstantBufferView.RootParameterIndex = D3D12RootBindings.Graphics.CbvB4;
		argumentDescs[6].Type = IndirectArgumentType.ConstantBufferView;
		argumentDescs[6].Anonymous.ConstantBufferView.RootParameterIndex = D3D12RootBindings.Graphics.CbvB14;
		argumentDescs[7].Type = IndirectArgumentType.ConstantBufferView;
		argumentDescs[7].Anonymous.ConstantBufferView.RootParameterIndex = D3D12RootBindings.Graphics.CbvB16;

		argumentDescs[8].Type = IndirectArgumentType.ShaderResourceView;
		argumentDescs[8].Anonymous.ShaderResourceView.RootParameterIndex = D3D12RootBindings.Graphics.SrvT10;
		argumentDescs[9].Type = IndirectArgumentType.ShaderResourceView;
		argumentDescs[9].Anonymous.ShaderResourceView.RootParameterIndex = D3D12RootBindings.Graphics.SrvT11;
		argumentDescs[10].Type = IndirectArgumentType.ShaderResourceView;
		argumentDescs[10].Anonymous.ShaderResourceView.RootParameterIndex = D3D12RootBindings.Graphics.SrvT12;
		argumentDescs[11].Type = IndirectArgumentType.ShaderResourceView;
		argumentDescs[11].Anonymous.ShaderResourceView.RootParameterIndex = D3D12RootBindings.Graphics.SrvT13;
		argumentDescs[12].Type = IndirectArgumentType.ShaderResourceView;
		argumentDescs[12].Anonymous.ShaderResourceView.RootParameterIndex = D3D12RootBindings.Graphics.SrvT14;
		argumentDescs[13].Type = IndirectArgumentType.ShaderResourceView;
		argumentDescs[13].Anonymous.ShaderResourceView.RootParameterIndex = D3D12RootBindings.Graphics.SrvT15;
		argumentDescs[14].Type = IndirectArgumentType.ShaderResourceView;
		argumentDescs[14].Anonymous.ShaderResourceView.RootParameterIndex = D3D12RootBindings.Graphics.SrvT16;

		argumentDescs[15].Type = IndirectArgumentType.DrawIndexed;
