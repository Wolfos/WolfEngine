...
public class RenderPipeline
{
    ...
    //     
    //     _camera = _world.CreateEntity("Camera", cameraTransform);
    //     _world.AddComponent(_camera, cameraComponent);
    //     _world.AddComponent(_camera, new CameraMover());
    //
    //     // Light
    //     var light = _world.CreateEntity("Directional Light", Vector3.Zero, Quaternion.CreateFromAxisAngle(Vector3.UnitX, 130), Vector3.One);
    ...
    //         };
    //         
    //         var entity = _world.CreateEntity(importedMesh.Name, transform);
    ...
    private static (Camera, Matrix4x4) CreateCamera()
    {
